                                        ...
                                        <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="padding:0 35px;">
                                                    <h1 style="color:#EFCC2D; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Falta pouco para você acessar a carteira da Vault!</h1>
                                                    <span
                                                        style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                                    <p style="color:#ffffff; font-size:15px;line-height:24px; margin:0;">Olá, ${nameUser}.
                                                        <br>
                                                        <br>
                                                       Agora que você já é assinante crie sua senha para acessar nossa carteira.
                                                        <br>
                                                        Clique no botão abaixo para criar sua senha.</p>
                                                    <a href="${resetLink}" style="margin-top:35px; padding:10px 24px;display:inline-block; background-color: #EFCC2D; color: #000000;">Complete seu cadastro</a>
                                                </td>
                                            </tr>
                                            <tr>
